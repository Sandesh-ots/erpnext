...
class Lead(SellingController, CRMNote):
    ...
    if TYPE_CHECKING:
        ...
        potential_volume: DF.Literal["", "1 vehicle", "2-5 vehicle", "6-10 vehicle", "11-25 vehicle", "25+ vehicle"]
        qualified_by: DF.Link | None
        qualified_on: DF.Date | None
        request_type: DF.Literal["", "Product Availability & Delivery Time", "Quotation Request", "Technical Information", "Service Request", "Maintenance Support", "Legal Enquiry", "Compliance / Documentation", "Media Enquiry", "References & Case Studies", "Press / News"]
        ...
        title: DF.Data | None
        type: DF.Literal["", "Individual buyer", "Fleet Operator / Delivery Company", "Distributor", "Operations / Logistics", "Shared Mobility Provider", "Governmental Institutions", "Investor", "Others"]
        unsubscribed: DF.Check
        urgency: DF.Literal["", "Immediate", "In 1 month", "In 3 months", "In 6 months", "In 1 year"]
